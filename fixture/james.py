...
class JamesHelper:
    ...
    def ensure_user_exists(self, username, password):
        james_configur = self.app.configur['james']
        session = JamesHelper.Session(james_configur["host"], james_configur["port"], james_configur["username"], james_configur["password"])
